...
static PyObject* LevelDB_Get(LevelDB* self, PyObject* args, PyObject* kwds)
{
	...
	return PyUnicode_FromStringAndSize(value, value_len);
}
...
static PyObject *LevelDB_ApproximateSizes(LevelDB *self, PyObject *args, PyObject *kwds)
{
	...
	for (int i = 0; i < num_ranges; i++) {
		...
		char_obj = PyBytes_AsString(obj_start_key);
		...
		char_obj = PyBytes_AsString(obj_limit_key);
...
PyMethodDef LevelDB_methods[] = {
	{(char*)"Put",       (PyCFunction)LevelDB_Put,       METH_VARARGS|METH_KEYWORDS, (char*)"add a key/value pair to database, with an optional synchronous disk write" },
	{(char*)"Get",       (PyCFunction)LevelDB_Get,       METH_VARARGS|METH_KEYWORDS, (char*)"get a value from the database" },
	{(char*)"Delete",    (PyCFunction)LevelDB_Delete,    METH_VARARGS|METH_KEYWORDS, (char*)"delete a value in the database" },
	{(char*)"Write",    (PyCFunction)LevelDB_Write,    METH_VARARGS|METH_KEYWORDS, (char*)"apply a writebatch in database" },
	{(char*)"Property",    (PyCFunction)LevelDB_Property,    METH_VARARGS|METH_KEYWORDS, (char*)"get a property value" },
	{(char*)"RepairDB",    (PyCFunction)LevelDB_RepairDB,    METH_VARARGS|METH_KEYWORDS, (char*)"repair database" },
	{(char*)"RangeIter",    (PyCFunction)LevelDB_RangeIter,    METH_VARARGS|METH_KEYWORDS, (char*)"range iterator" },
    {(char*)"CompactRange", (PyCFunction)LevelDB_CompactRange,  METH_VARARGS|METH_KEYWORDS, (char*)"range compact" },
	{(char*)"GetApproximateSizes",    (PyCFunction)LevelDB_ApproximateSizes,    METH_VARARGS|METH_KEYWORDS, (char*)"get approximate sizes." },
	{(char*)"Close",    (PyCFunction)LevelDB_Close,    METH_VARARGS|METH_KEYWORDS, (char*)"close database" },
